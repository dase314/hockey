...
public:
    ...
    virtual MutablePtr cloneEmptyFromPmem(pmem::obj::persistent_ptr<pmem::obj::string> &) const { 
      throw Exception("Cannot cloneEmptyFromPmem() column " + getName(), ErrorCodes::NOT_IMPLEMENTED); 
    }
    ...
    virtual void insertPmemRangeFrom(const IColumn &, size_t, size_t) 
    {
      throw Exception("Method insertPmemRangeFrom is not supported for " + getName(), ErrorCodes::NOT_IMPLEMENTED);
    }

    virtual void insertRangeFromPmem(const IColumn &, size_t, size_t) 
    {
      throw Exception("Method insertRangeFromPmem is not supported for " + getName(), ErrorCodes::NOT_IMPLEMENTED);
    }

    virtual void insertMemRangeFrom(size_t, size_t) 
    {
      throw Exception("Method insertMemRangeFrom is not supported for " + getName(), ErrorCodes::NOT_IMPLEMENTED);
    }
    ...
    virtual size_t byteSizePmem() const
    {
      throw Exception("Method byteSizePmem is not supported for " + getName(), ErrorCodes::NOT_IMPLEMENTED);
    }
