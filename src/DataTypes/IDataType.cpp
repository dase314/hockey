...
void IDataType::serializeToPmem(const IColumn &, char *) const
{
    throw Exception("Data type " + getName() + " not support serialize to pmem", ErrorCodes::LOGICAL_ERROR);
}

void IDataType::deserializeFromPmem(IColumn &, char *, size_t) const
{
    throw Exception("Data type " + getName() + " not support deserialize from pmem", ErrorCodes::LOGICAL_ERROR);
}

void IDataType::deserializeFromPmemCpy(IColumn &, char *, size_t) const
{
    throw Exception("Data type " + getName() + " not support deserialize from pmem", ErrorCodes::LOGICAL_ERROR);
}
