...
public:
    ...
    void serializeToPmem(const IColumn & column, char * pmem_addr) const override;
    void deserializeFromPmem(IColumn & column, char * pmem_addr, size_t offset) const override;
    void deserializeFromPmemCpy(IColumn & column, char * pmem_addr, size_t offset) const override;
