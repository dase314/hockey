    ...
    : IStorage(table_id_)
{
    ...
    storage_metadata.setColumns(ColumnsDescription(
    {
        ...
        {"disk_type", std::make_shared<DataTypeString>()},
    }));
    ...
    const unsigned /*num_streams*/)
{
    ...
    MutableColumnPtr disk_type = ColumnString::create();
    ...
    for (const auto & [disk_name, disk_ptr] : context.getDisksMap())
    {
        ...
        disk_type->insert(disk_ptr->getDiskType());
    }
    ...
    res_columns.emplace_back(std::move(disk_type));
